(function() {
  ...
  **/
  ...
  ShootingStar.prototype.addBeamPart = function(x, y) {
    ...
    $("#star" + name).append("<div id='haz" + this.n + "' class='haz' style='position:absolute; color: yellow; width:15px; height:15px; font-weight:bold; font-size:" + this.options.starSize + "px'>·</div>");
